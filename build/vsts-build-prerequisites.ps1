# Install the required powershell get module. This needs to be done sperately
# since after installation of the module, a new session must be created (the 
# one which actually performs the build process).
#
