...
try
{
	Install-Module "PowershellGet" -SkipPublisherCheck -Force -RequiredVersion "2.2.2" -Verbose -ErrorAction Stop
}
catch
{
	Write-Header "Could not install 'PowershellGet' v2.2.2" -Colour Red
}
